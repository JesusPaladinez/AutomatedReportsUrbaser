...
export default function Report({ nameReport, imgReport }) {
  return (
    <div className='bg-white w-96 h-52 p-6 pl-7 border border-gray-300 rounded-lg relative overflow-hidden transform transition-transform ease-in-out hover:scale-105 hover:shadow-xl'>
